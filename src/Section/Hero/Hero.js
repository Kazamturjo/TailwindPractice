...
const Hero = () => {
  ...
  return (
    <section
      id='home'
      className='ml-6 w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container'
    >
      ...
      <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-blue-100 bg-hero bg-cover bg-center rounded-lg'>
        <img
          src={bigShoeImg}
          alt='shoe colletion'
          width={610}
